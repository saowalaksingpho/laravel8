                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary">
                                        ...
                                        <span class="float-right">
                                            <form class="form-inline">
                                                <button type="button" class="btn btn-light" onclick="drawProgress('-1');"><i class="fas fa-chevron-left text-gray-500"></i></button>
                                                <input class="form-control" id="user_id" min="1" max="" value="1" style="width: 50px;" />
                                                <span class="mx-2"> of </span>
                                                <span id="users_length">M</span>
                                                <button type="button" class="btn btn-light" onclick="drawProgress('+1');"><i class="fas fa-chevron-right text-gray-500"></i></button>
                                            </form>
                                        </span>
                                    </h6>
                                </div>
