...
<div class="form-group {{ $errors->has('leave_type_name') ? 'has-error' : '' }}">
    ...
    <select name="leave_type_name" class="form-control" id="leave_type_name">
        ...
        <option value="{{ $optionKey }}" {{ isset($leaverequest->leave_type_name) && $leaverequest->leave_type_name == $optionKey ? 'selected' : '' }}>
            {{ $optionValue }}
        </option>
        @endforeach
    </select>
...
<div class="form-group {{ $errors->has('status') ? 'has-error' : '' }}">
    ...
    <select name="status" class="form-control" id="status">
        ...
        <option value="{{ $optionKey }}" {{ isset($leaverequest->status) && $leaverequest->status == $optionKey ? 'selected' : '' }}>
            {{ $optionValue }}
        </option>
        @endforeach
    </select>
